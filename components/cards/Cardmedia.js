          ...
          <Card sx={{ maxWidth: "auto", justifyContent: "center" }}>
            ...
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary">
                This guide to jobs for new immigrants in the USA is a great
        ...
        <Link href={"/mainPageSections/housingfood"} passHref>
          <Card sx={{ maxWidth: "auto", m: "auto" }}>
            ...
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary">
                Welcome to the United States: A Guide for New Immigrants to
                search for Housing and find Food.
              </Typography>
            </CardContent>
            <CardActions>
              <Button size="small">Learn More</Button>
        ...
        <Link href={"/mainPageSections/educationlanguage"} passHref>
          <Card sx={{ maxWidth: "auto", m: "auto" }}>
            ...
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary">
                Immerse Yourself In Innovative Teaching and Learning Methods,
                Search Us Today.
              </Typography>
            </CardContent>
            <CardActions>
